...
class SendCall():
    ...
    def Vajini(self):
        try:
            ...
            data = {"name": self.ad, "email": self.mail, "emailid": "1,Telefon Numaran\xc4\xb1z,", "subject": "Cinsel İstikrarsızlık", "message": "Cinsel İsteksizlik", "extra0": self.phone, "extravalues": f"#{self.phone}", "option": "com_alfcontact", "task": "sendemail", "emailto_id": "1", "34678c7059ce93f3539d11c789db1afe": "1"}
